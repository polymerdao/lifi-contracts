...
contract CallPolymerCCTPFacet is Script {
    function run() external payable {
        ...
        // LI.FI chain id of the destination; must be present in the facet's
        // on-chain mapping (seeded at init) or the bridge call reverts with
        // UnsupportedChainId.
        ...
        uint256 maxCCTPFee = vm.envOr("MAX_CCTP_FEE", uint256(100));
        ...
        PolymerCCTPFacet.PolymerCCTPData memory polymerData = PolymerCCTPFacet
            .PolymerCCTPData({
